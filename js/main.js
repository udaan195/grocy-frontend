document.addEventListener('DOMContentLoaded', () => {
        ...
        if (checkoutBtn) {
            checkoutBtn.addEventListener('click', () => {
                if (localStorage.getItem('userInfo')) {
                    if (cart.length > 0) {
                        // चेकआउट पर जाने से पहले प्रोडक्ट्स की पूरी लिस्ट भी सेव करें
                        localStorage.setItem('productsDataForCheckout', JSON.stringify(allProducts));
    ...
    async function init() {
        // Step 1: पहले सभी प्रोडक्ट्स का इंतज़ार करें
